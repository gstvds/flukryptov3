...
export declare class Collection<DataType = DefaultDataItem> {
    ...
    createGroup(groupName: GroupName): Group<DataType>;
    saveData(data: DataType): PrimaryKey;
    /**
     ...
     */
    collect(items: DataType | Array<DataType>, groups: GroupName | Array<GroupName>): void;
    /**
     ...
     */
    getGroup(groupName: string | number): Group;
    /**
